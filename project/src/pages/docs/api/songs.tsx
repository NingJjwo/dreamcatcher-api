  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        Get songs from a group
        </h1>
        <p className="text-xl text-muted-foreground leading-relaxed">
         Get songs from a group by its ID
        </p>
      </div>
      ...
      <Card className="p-6 bg-card/50 border-mystery-accent/20">
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <code className="text-lg text-mystery-blue font-mono">/albums/songs</code>
          </div>
          
          <p className="text-muted-foreground">
            Endpoint for get information basic the songs from a group by its ID.
          </p>
        </div>
      </Card>

      <div className="space-y-6">
        <h2 className="text-2xl font-semibold font-dm-serif">Example response
        </h2>
        <Card className="p-6 bg-card/50 border-mystery-accent/20">
...
{`{
  ...
  "total_groups": 2
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold font-dm-serif">Example of use</h2>
        <Card className="p-6 bg-card/50 border-mystery-accent/20">
